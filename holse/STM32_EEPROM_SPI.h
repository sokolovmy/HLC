...
//pagesize for 95160 - 32, 95256 - 64
...
#define EEPROM_CS_HIGH()    HAL_GPIO_WritePin(PIN_EEPROM_SELECT_GPIO_Port, PIN_EEPROM_SELECT_Pin, GPIO_PIN_SET)
#define EEPROM_CS_LOW()     HAL_GPIO_WritePin(PIN_EEPROM_SELECT_GPIO_Port, PIN_EEPROM_SELECT_Pin, GPIO_PIN_RESET)
