...
char signature[] = "S4b8249f1fd7ee005a77bdfbdd2z9108";
struct __attribute__((__packed__)) {
	ConfigInput configInputs[32]; //< btn down
	ConfigInput configInputsClick[32]; //< btn click
	ConfigInput configInputsDoubleClick[32]; //< btn double click
	ConfigInput configInputsLPress[32];
	ConfigTimer configTimers[32];
} config;
