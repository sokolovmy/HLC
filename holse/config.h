...
#define MAX_OUTPUTS 32 //< define outputs count
#define MAX_INPUTS 32 //< define inputs count
#define MAX_INPUTS_STR "31"
#define MAX_TIMERS 32 //< define timers count
#define MAX_INPUTS_BYTES MAX_INPUTS/8
#define MAX_OUTPUTS_BYTES MAX_OUTPUTS/8




typedef uint32_t BitPorts; //< change this type if max inputs contains more bits
